...
<TipBox>
  The Network Canvas team is developing Network Canvas Studio, a cloud-based
  platform that will resolve many of the complexities associated with managing
  protocols and exporting data.
</TipBox>
...
<ImageFullWith
  src="/assets/img/offline-data/online.png"
  name="Online workflow diagram"
/>
...
<ImageFullWith
  src="/assets/img/offline-data/offline.png"
  name="Offline workflow diagram"
/>
...
<TipBox>
  ...
  to transfer the protocol file can be read by the device running the Network
  Canvas Interviewer App _and_ the device running Architect.
</TipBox>
